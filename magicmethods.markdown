...
## [Introduction](https://github.com/RafeKettler/magicmethods/blob/master/magicmethods.markdown#intro)
...
## [Construction and Initialization](https://github.com/RafeKettler/magicmethods/blob/master/magicmethods.markdown#construction)
...
## [Making Operators Work on Custom Classes](https://github.com/RafeKettler/magicmethods/blob/master/magicmethods.markdown#operators)
...
### [Comparison magic methods](https://github.com/RafeKettler/magicmethods/blob/master/magicmethods.markdown#comparisons)
...
### [Numeric magic methods](https://github.com/RafeKettler/magicmethods/blob/master/magicmethods.markdown#numeric) 
...
`__invert__(self)` : Implements behavior for inversion using the `~` operator. For an explanation on what this does, see [the Wikipedia article on bitwise operations](http://en.wikipedia.org/wiki/Bitwise_operation#NOT).
...
`__truediv__(self, other)` : Implements _true_ division. Note that this only works when `from __future__ import division` is in effect.
...
`__rtruediv__(self, other)` : Implements reflected _true_ division. Note that this only works when `from __future__ import division` is in effect.
...
`__itruediv__(self, other)` : Implements _true_ division with assignment. Note that this only works when `from __future__ import division` is in effect.
...
## [Representing your Classes](https://github.com/RafeKettler/magicmethods/blob/master/magicmethods.markdown#representations) 
...
## [Controlling Attribute Access](https://github.com/RafeKettler/magicmethods/blob/master/magicmethods.markdown#access) 
...
## [Making Custom Sequences](https://github.com/RafeKettler/magicmethods/blob/master/magicmethods.markdown#sequence) 
...
## [Reflection](https://github.com/RafeKettler/magicmethods/blob/master/magicmethods.markdown#reflection) 
...
## [Callable Objects](https://github.com/RafeKettler/magicmethods/blob/master/magicmethods.markdown#callable) 
...
## [Context Managers](https://github.com/RafeKettler/magicmethods/blob/master/magicmethods.markdown#context) 
...
`__enter__(self)` : Defines what the context manager should do at the beginning of the block created by the `with` statement. Note that the return value of `__enter__` is bound to the _target_ of the `with` statement, or the name after the `as`.
...
## [Abstract Base Classes](https://github.com/RafeKettler/magicmethods/blob/master/magicmethods.markdown#abcs) 
See [http://docs.python.org/2/library/abc.html](http://docs.python.org/2/library/abc.html).

## [Building Descriptor Objects](https://github.com/RafeKettler/magicmethods/blob/master/magicmethods.markdown#descriptor) 
...
## [Copying](https://github.com/RafeKettler/magicmethods/blob/master/magicmethods.markdown#copying) 
...
`__copy__(self)` : Defines behavior for `copy.copy()` for instances of your class. `copy.copy()` returns a _shallow copy_ of your object -- this means that, while the instance itself is a new instance, all of its data is referenced -- i.e., the object itself is copied, but its data is still referenced (and hence changes to data in a shallow copy may cause changes in the original).
...
## [Pickling Your Objects](https://github.com/RafeKettler/magicmethods/blob/master/magicmethods.markdown#pickling) 
...
## [Conclusion](https://github.com/RafeKettler/magicmethods/blob/master/magicmethods.markdown#conclusion) 
